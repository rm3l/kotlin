...
internal class DescriptorRendererImpl(
    ...
    private fun renderMemberModifiers(descriptor: MemberDescriptor, builder: StringBuilder) {
        ...
        renderModifier(builder, DescriptorRendererModifier.HEADER in modifiers && descriptor.isHeader, "expect")
        renderModifier(builder, DescriptorRendererModifier.IMPL in modifiers && descriptor.isImpl, "actual")
    }
